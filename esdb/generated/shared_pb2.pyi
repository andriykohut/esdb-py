...
class UUID(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["value", b"value"]) -> typing_extensions.Literal["structured", "string"] | None: ...
...
class WrongExpectedVersion(google.protobuf.message.Message):
    ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["current_stream_revision_option", b"current_stream_revision_option"]) -> typing_extensions.Literal["current_stream_revision", "current_no_stream"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["expected_stream_position_option", b"expected_stream_position_option"]) -> typing_extensions.Literal["expected_stream_position", "expected_any", "expected_stream_exists", "expected_no_stream"] | None: ...
